...
function ApplyCSSResponsiveChanges(strAttrib, thisObj, tempObj, bOnlyDoTextScaling)
{
	...
	else if(strAttrib.indexOf("width") > -1 && !(strAttrib.indexOf("width") > 0))
	{
		newAttrib = "width:"+thisObj.w+"px;";
	}
	else if(strAttrib.indexOf("height") > -1 && !(strAttrib.indexOf("height") > 0))
	{
	...
	else if(strAttrib.indexOf("background-color") > -1 && !(strAttrib.indexOf("background-color") > 0))
	{
		newAttrib = "background-color:"+thisObj.bgColor+";";
	}
